...
const AboutMe = () => {
  ...
  return (
    <div className="px-2 md:px-[100px] lg:px-[400px]" id="about-me">
      <div className="h-full flex flex-col items-center gap-5 justify-center bg-[#e7e8ea] rounded-[60px] relative font-ubuntu px-4 py-12 md:p-12">
        <AnimationWrapper delay={0.5}>
          <div className="text-xl lg:text-5xl text-left flex text-primary font-bold">ABOUT ME</div>
        </AnimationWrapper>

        <div className="grid grid-cols-6 gap-4 lg:gap-2">
          <div className="col-span-6 lg:col-span-4">
            <AnimationWrapper delay={1}>
              <div className="flex flex-col gap-2 text-left text-primary ">
                ...
                <p className="text-lg text-justify font-normal text-text-primary">
                  ...
                  <br />
                  <br />
                  My career began with 1 year and 9 months as a Front End Developer at Kolabora Group, where I deepened
                  my knowledge in front-end development. Currently, I am a Full Stack Engineer at Sprint Asia,
                  continuing to apply my skills across both front-end and back-end development.
                </p>
              </div>
            </AnimationWrapper>
          </div>
          ...
          <div className="col-span-6 lg:col-span-2">
            <AnimationWrapper delay={1.25}>
              <img alt="profile-img" src={profile} className="w-72 h-72 rounded-full object-cover" />
            </AnimationWrapper>
          </div>
        </div>

        <div className="absolute top-3/4 md:top-10 right-10 opacity-80 md:opacity-100">
